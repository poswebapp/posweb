...
const TopContent = () => {
  ...
  return (
    <content className="flex flex-row justify-apart content-start grid-cols-4 gap-8 w-full mx-auto">
...
export const Content = ({ name, value, border }) => {
  return (
    <span className={`flex justify-start content-apart  border-l-8 bg-zinc-100 h-30 max-w-40 shadow-md rounded-lg p-4 text-md font-bold text-zinc-600 ${border}`}>
