...
const Term = () => {
  return (
    <div className="p-5 w-screen max-w-sm mx-auto">
      ...
      <p className="text-sm text-gray-500">
        ...
        of AppName's Website, located at AppName.com By accessing this website
        we assume you accept these terms and conditions. Do not continue to use
        AppName if you do not agree to take all of the terms and conditions
        ...
        Agreements: "Client", "You" and "Your" refers to you, the person log on
      ...
      <p className="text-gray-500 font-semibold text-md">Cookies</p>

      <p className="text-sm text-gray-500">
        We employ the use of cookies. By accessing AppName, you agreed to use
        cookies in agreement with the AppName's Privacy Policy. Most interactive
      ...
      <p className="text-gray-500 font-semibold text-md"> License</p>
      <p className="text-sm text-gray-500">
        ...
        terms and conditions. You must not: Republish material from AppName
        Sell, rent or sub-license material from AppName Reproduce, duplicate or
        copy material from AppName Redistribute content from AppName This
        ...
        certain areas of the website. AppName does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of AppName,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, AppName
        ...
        of and/or appearance of the Comments on this website. AppName reserves
        the right to monitor all Comments and to remove any Comments which can
        be considered inappropriate, offensive or causes breach of these Terms
        and Conditions. You warrant and represent that: You are entitled to post
        the Comments on our website and have all necessary licenses and consents
        to do so; The Comments do not invade any intellectual property right,
        ...
        AppName a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p className="text-sm text-gray-500">
        ...
        organizations; Online directory distributors may link to our Website in
        ...
        the hyperlink compensates the absence of AppName; and (d) the link is in
        the context of general resource information. These organizations may
        ...
        to our website, you must inform us by sending an e-mail to AppName.
        ...
        organizations may hyperlink to our Website as follows: By use of our
        corporate name; or By use of the uniform resource locator being linked
        to; or By use of any other description of our Website being linked to
        that makes sense within the context and format of content on the linking
        party’s site. No use of AppName's logo or other artwork will be allowed
        for linking absent a trademark license agreement. iFrames Without prior
        approval and written permission, you may not create frames around our
        Webpages that alter in any way the visual presentation or appearance of
        our Website.
      </p>

      <p className="text-gray-500 font-semibold text-md">Content Liability</p>
      <p className="text-sm text-gray-500">
        ...
        any third party rights. Your Privacy Please read Privacy Policy
        Reservation of Rights We reserve the right to request that you remove
        all links or any particular link to our Website. You approve to
        ...
        policy at any time. By continuously linking to our Website, you agree to
      ...
      <p className="text-gray-500 font-semibold text-md">Disclaimer</p>
      <p className="text-sm text-gray-500">
